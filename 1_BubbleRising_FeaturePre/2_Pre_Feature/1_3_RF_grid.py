...
save_path = os.path.join(script_directory, 'b_3_Results_rf_pre_feature.csv')
best_rf_dir = os.path.join(script_directory, 'a_best_rf_model')
os.makedirs(best_rf_dir, exist_ok=True)
...
for target_col in target_columns:
    ...
    param_grid = {
        'n_estimators': [20, 50, 100, 200, 300, 400, 500,600,700,800,900,1000],  # Added more values
        'max_depth': [None, 10, 20, 30, 40, 50],  # Added more values
        'min_samples_split': [2, 5, 10, 15, 20],  # Added more values
        'min_samples_leaf': [1, 2, 4, 8, 16]  # Added more values
    }
    # 创建GridSearchCV对象
    ...
    model_path = os.path.join(best_rf_dir, f'rf_best_model_{target_col}.joblib')
