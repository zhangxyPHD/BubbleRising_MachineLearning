...
save_path = os.path.join(script_directory, 'b_3_Results_rf_pre_feature_log_StandardScaler.csv')
best_rf_dir = os.path.join(script_directory, 'a_best_rf_model_log_StandardScaler')
...
scaler_path = os.path.join(best_rf_dir, 'scaler_model.pkl')   
